...
import com.guvi.gt.lataxi.adapter.CarTypeRecyclerAdapter;
...
import com.guvi.gt.lataxi.listeners.PermissionListener;
...
import com.guvi.gt.lataxi.net.WSAsyncTasks.FCMRegistrationTask;
import com.guvi.gt.lataxi.net.WSAsyncTasks.LocationNameTask;
import com.guvi.gt.lataxi.net.WSAsyncTasks.LocationTask;
...
//            postData.put("user_id", userBean.getUserID());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_SEARCH_DESTINATION_SELECT && resultCode == RESULT_OK) {
            ...
            if (sourceBean.getName() != null & destinationBean.getName() != null) {
...
/*        CarBean bean1 = landingPageBean.getCars().get(0);
       ...
       /* if (carType.equalsIgnoreCase("1")) {
        ...
        btnRequest.setText("Request " + landingPageBean.getCar(carType).getCarName());
...
//            getLocationName(LastLocation.getLatitude(), LastLocation.getLongitude());
    ...
    protected void getLocationName(String latitude, String longitude) {
