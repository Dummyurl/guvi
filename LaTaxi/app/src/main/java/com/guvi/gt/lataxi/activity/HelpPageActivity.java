...
//            mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
    ...
    public void mapAutoZoom() {
        ...
        newLatLng1 = new LatLng(Double.parseDouble(bean.getSourceLatitude()), Double.parseDouble(bean.getSourceLongitude()));
        newLatLng2 = new LatLng(Double.parseDouble(bean.getDestinationLatitude()), Double.parseDouble(bean.getDestinationLongitude()));
    ...
    public void onRecieptClick(View view) {
    ...
    public void performTripFeedback() {
        ...
        DataManager.performTripFeedback(postData, new TripFeedbackListener() {
            ...
            public void onLoadCompleted(TripFeedbackBean tripFeedbackBean) {
                ...
                Toast.makeText(getApplicationContext(), "Feedback is successfully sent",
            ...
            public void onLoadFailed(String error) {
                ...
                Toast.makeText(getApplicationContext(), "Feedback is not sent",
                        Toast.LENGTH_LONG).show();
                swipeView.setRefreshing(false);
    ...
    public void onHelpPageFeedbackSubmitClick(View view) {
        ...
        if (tripFeedbackType != null) {
            ...
            Snackbar.make(coordinatorLayout, "Select A FeedBack", Snackbar.LENGTH_LONG)
