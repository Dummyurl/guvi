...
//            txtMinutes.setText(tripDetailsBean.getMinute());
    ...
    private void populateMap() {
        mMap.clear();
        onPlotLatLng(Double.parseDouble(tripDetailsBean.getSourceLatitude()), Double.parseDouble(tripDetailsBean.getSourceLongitude()),
                Double.parseDouble(tripDetailsBean.getDestinationLatitude()), Double.parseDouble(tripDetailsBean.getDestinationLongitude()));
        mapAutoZoom();
    }
...
//            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(newLatLng, 11));
    ...
    public void mapAutoZoom() {
        ...
        newLatLng1 = new LatLng(Double.parseDouble(tripDetailsBean.getSourceLatitude()), Double.parseDouble(tripDetailsBean.getSourceLongitude()));
        newLatLng2 = new LatLng(Double.parseDouble(tripDetailsBean.getDestinationLatitude()), Double.parseDouble(tripDetailsBean.getDestinationLongitude()));
    ...
    public void fetchPolyPoint() {
        ...
        sourceLatitude = Double.parseDouble(tripDetailsBean.getSourceLatitude());
        sourceLongitude = Double.parseDouble(tripDetailsBean.getSourceLongitude());
        destinationLatitude = Double.parseDouble(tripDetailsBean.getDestinationLatitude());
        destinationLongitude = Double.parseDouble(tripDetailsBean.getDestinationLongitude());
