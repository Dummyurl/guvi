...
import com.guvi.gt.lataxidriver.adapter.IssueListRecyclerAdapter;
import com.guvi.gt.lataxidriver.app.App;
import com.guvi.gt.lataxidriver.listeners.IssueListListener;
import com.guvi.gt.lataxidriver.model.IssueBean;
...
/*            setMessageScreenVisibility(true, false, false, 0,
    ...
    private void setIssueListBean(IssueListBean issueListBeanWS, boolean isLoadMore) {
        ...
        if (isLoadMore && issueListBean != null && issueListBean.getIssues() != null) {
            ...
            List<IssueBean> listExisting = issueListBean.getIssues();
            List<IssueBean> listFromWS = issueListBeanWS.getIssues();
