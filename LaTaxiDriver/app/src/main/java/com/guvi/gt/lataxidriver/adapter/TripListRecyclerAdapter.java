...
import static com.guvi.gt.lataxidriver.app.App.DATE_FORMAT_1;
import static com.guvi.gt.lataxidriver.app.App.TIME_FORMAT_0;
...
public class TripListRecyclerAdapter extends RecyclerView.Adapter<TripListRecyclerAdapter.ViewHolder> {
    ...
    private void setLayoutTrip(final ViewHolder holder, final int position) {
        ...
        Glide.with(mContext.getApplicationContext())
                ...
                .apply(new RequestOptions().placeholder(R.drawable.ic_profile_photo_default))
