package com.guvi.gt.lataxidriver.util;

import com.google.gson.Gson;

import com.guvi.gt.lataxidriver.R;
import com.guvi.gt.lataxidriver.app.App;
import com.guvi.gt.lataxidriver.model.CountryBean;
import com.guvi.gt.lataxidriver.model.CountryListBean;
...
public class AppConstants {
    ...
    public static String ACTION_CHOOSE_REMINDER = "com.guvi.gt.lataxidriver.action.CHOOSE_REMINDER";
    public static String ACTION_CHOOSE_MONTH = "com.guvi.gt.lataxidriver.action.CHOOSE_MONTH";
    public static String ACTION_CHOOSE_DAY = "com.guvi.gt.lataxidriver.action.CHOOSE_DAY";
    public static String ACTION_CHOOSE_YEAR = "com.guvi.gt.lataxidriver.action.CHOOSE_YEAR";
    public static String ACTION_CHOOSE_COURT_TYPE = "com.guvi.gt.lataxidriver.action.CHOOSE_COURT_TYPE";
    public static String ACTION_CHOOSE_COUNTRY = "com.guvi.gt.lataxidriver.action.CHOOSE_COUNTRY";
    public static String ACTION_CHOOSE_STATE = "com.guvi.gt.lataxidriver.action.CHOOSE_STATE";
    public static String ACTION_CHOOSE_DISTRICT = "com.guvi.gt.lataxidriver.action.CHOOSE_CITY";
    public static String ACTION_CHOOSE_AGE = "com.guvi.gt.lataxidriver.action.CHOOSE_AGE";
