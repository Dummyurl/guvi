...
import com.guvi.gt.lataxidriver.adapter.CommentListRecyclerAdapter;
import com.guvi.gt.lataxidriver.app.App;
import com.guvi.gt.lataxidriver.listeners.CommentListListener;
import com.guvi.gt.lataxidriver.model.CommentBean;
import com.guvi.gt.lataxidriver.model.CommentListBean;
import com.guvi.gt.lataxidriver.model.PaginationBean;
...
/*            setMessageScreenVisibility(true, false, false, 0,
    ...
    private void setCommentListBean(CommentListBean commentListBeanWS, boolean isLoadMore) {
        ...
        if (isLoadMore && commentListBean != null && commentListBean.getComments() != null) {
            ...
            List<CommentBean> listExisting = commentListBean.getComments();
            List<CommentBean> listFromWS = commentListBeanWS.getComments();
